...
<head>
  ...
  <title>Returnee Applicants</title>
</head>
<body>
  ...
  <div class="flex">
    ...
    <div class="ml-72 p-5 w-full">
      ...
      <h1 class="text-2xl mb-2">Returnee Applicants Report</h1>
      <div class="flex justify-end items-center space-x-4">
        <div class="ml-2">
          <select class="usermanage-search-bar h-10 pl-2 pr-10 border border-gray-300 rounded-md bg-white cursor-pointer">
            <option value="all">Generate by</option>
      ...
      <!-- More content for the Hired Applicants Report -->
    </div>
  </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const reportsModuleToggle = document.getElementById("reportsModuleToggle");

      // Toggle dropdown when "Reports" menu item is clicked
      reportsModuleToggle.addEventListener("click", function(e) {
        e.preventDefault();
        reportsDropdown.classList.toggle("hidden");
      });

      // Automatically open the Reports dropdown if on the hiredApplicants route
      if (routeName === "returneeApplicants") {
